...
public class Desafio03 {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            x2 = sc.nextInt();
            y2 = sc.nextInt();
            if(x1 == 0 && y1 == 0 && x2 == 0 && y2 == 0) break; //condição de parada(entrada com zeros)
            if(x1 == x2 && y1 == y2)
                System.out.println("0"); //nenhum movimento
            else if(x1 == x2 || y1 == y2)
                System.out.println("1"); //um movimento na horizontal/vertical
            else if((x2-x1)==-(y2-y1) || -(x2-x1)==-(y2-y1) || -(x2-x1)==(y2-y1) || (x2-x1)==(y2-y1))
                System.out.println("1"); //um movimento na diagonal
            else
                System.out.println("2"); //dois movimentos
        }
        sc.close();
    }
}
